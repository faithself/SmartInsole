...
public class DevicesFragment extends ListFragment {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if(item.driver == null) {
            ...
            Fragment fragment = new FeetFsrValueFragment();
            fragment.setArguments(args);
            getParentFragmentManager().beginTransaction().replace(R.id.fragment, fragment, "feets_fsr_show").addToBackStack(null).commit();
        }
    }
